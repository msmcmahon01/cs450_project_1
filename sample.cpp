...
const char *WINDOWTITLE = "OpenGL / Project 1 McMahon";
...
InitGraphics( )
{
	...
	glutInitWindowPosition((GetSystemMetrics(SM_CXSCREEN) - INIT_WINDOW_SIZE) / 2, (GetSystemMetrics(SM_CYSCREEN) - INIT_WINDOW_SIZE) / 2 );
